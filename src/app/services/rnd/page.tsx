...
const divisions = [
  {
    title: "R&D Solutions",
    desc: "Pioneering research initiatives and custom development to address unique challenges.",
    icon: "🔬",
  },
  {
    title: "Engineering Innovations",
    desc: "Creating advanced prototypes, designs, and systems to lead industry advancements.",
    icon: "💡",
  },
];
    ...
    <main className="pt-24">
      <section className="relative min-h-[60vh] flex items-center overflow-hidden px-5 md:px-12 lg:px-[60px] py-20 md:py-24">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <SectionLabel>Division 04</SectionLabel>
          <h1 className="font-bebas text-[clamp(3rem,6vw,5rem)] leading-[0.95] text-white mt-2">
            R&D & <span className="text-primary">Innovation</span>
          </h1>
          <p className="text-xl text-white/75 mt-6 leading-relaxed">
            Turning bold ideas into groundbreaking solutions for a better
            tomorrow.
          </p>
        </div>
      </section>
