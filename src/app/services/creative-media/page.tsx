...
const divisions = [
  {
    title: "Digital Advertising & Entertainment",
    desc: "Crafting impactful advertisements and immersive entertainment experiences to engage your audience on a deeper level.",
    icon: "📢",
  },
  {
    title: "Digital Audio Production",
    desc: "From original compositions to sound design, we produce exceptional audio that elevates every project.",
    icon: "🎵",
  },
  {
    title: "3D Animation",
    desc: "Stunning visual storytelling through high-quality animations that captivate and inspire.",
    icon: "🎬",
  },
  {
    title: "Game Development",
    desc: "Developing immersive, innovative games with unique concepts and unforgettable gameplay.",
    icon: "🎮",
  },
];
    ...
    <main className="pt-24">
      <section className="relative min-h-[60vh] flex items-center overflow-hidden px-5 md:px-12 lg:px-[60px] py-20 md:py-24">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <SectionLabel>Division 01</SectionLabel>
          <h1 className="font-bebas text-[clamp(3rem,6vw,5rem)] leading-[0.95] text-white mt-2">
            Creative Media <span className="text-primary">Solutions</span>
          </h1>
          <p className="text-xl text-white/75 mt-6 leading-relaxed">
            Bring your brand and ideas to life with unforgettable visuals, sound,
            and gameplay.
          </p>
        </div>
      </section>
